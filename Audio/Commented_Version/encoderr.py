...
def encode(in_file, out_file):
    """
        ...
        example: python encoderr.py encode "path of file intended for compression" "path of directory where to save .npz file with the specified name for it "
        """
...
def decode(in_file, out_file):
    ...
    example : python encoder.py decode "path of the .npz file inteded for reconstructing" " path of directory where to save the reconstructed audio file "
    """
    # Load the model
    autoencoder = keras.models.load_model("autoencoder.model")
